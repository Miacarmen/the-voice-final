        ...
        <>
          ...
          <div className='book-content text-secondary'>
            ...
            <figure className='m-5 bookImgContainer mobile-first'>
              <img src={BookCover} alt='Book Cover' className='bookCoverImg' />
              <Link to='/artistbio'>
            ...
            <div className='paragraph-container'>
              ...
              <p className='book-back'>
                All of these experiences have transformed my understanding of
                religion, faith and God. I've come to realize that to bring
            ...
            <div className='hero-content grid grid-cols-2 bg-base-100 shadow-black'>
              <div className='book-content text-secondary'>
                ...
                <div className='paragraph-container'>
                  ...
                  <p className='book-back'>
                    All of these experiences have transformed my understanding
                    of religion, faith and God. I've come to realize that to
                    bring change to the world, this family of Off-Planet
                    Intelligence does not kill to conquer. They open hearts that
                    enable us to see through the eyes of spirit.
                  </p>
                </div>
              </div>
